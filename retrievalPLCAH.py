...
data_dir =  "/home/rh/savepr/DPNCOTSOF2/coco-[64]-0.9059791713024425-"
...
img_dir = "/home/rh/data/coco/"
with open("/home/rh/data/COCO/database.txt", "r") as f:
    trn_img_path = [img_dir + item.split(" ")[0] for item in f.readlines()]
with open("/home/rh/data/COCO/test.txt", "r") as f:
    tst_img_path = [img_dir + item.split(" ")[0] for item in f.readlines()]


img="train2014/COCO_train2014_000000123514.jpg"
...
plt.savefig("demo24.png")

plt.show()
img1 = Image.open('demo24.png')
plt.imshow(img1)
print(img1)
